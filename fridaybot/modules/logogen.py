...
async def _(event):
    ...
    if not input_st:
      ommhg = await friday.edit_or_reply(event, "Give name and type for logo Idiot. like `.logogen messi:football`")
      return
    ...
    try:
      ...
      ommg = await friday.edit_or_reply(event, "Wrong Input. Give Input like `.logogen messi:football`. Continuing with `name` as type this time.")
      name = input_str
      typeo = "name"
